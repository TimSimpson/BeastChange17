    ...
    boost::asio::yield_context yield)
{
    ...
    // "boost::asio::socket_base::max_listen_connections" not found
    constexpr int max_listen_connections = 10000;
...
int main(int argc, char* argv[])
{
    ...
    auto const address = boost::asio::ip::address_v4::from_string(argv[1]);
